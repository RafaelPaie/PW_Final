package com.example.rafaelpaiement.backinthegame;
...
public class MainActivity extends AppCompatActivity {
    ...
    */
    ...
    ui.getConfiguration().setTerminalParameters(accessoryParameters);
    */
        EditText et = (EditText) findViewById(R.id.amt);
        String str = et.getEditableText().toString();

        TransactionParameters transactionParameters = new TransactionParameters.Builder()
                .charge(new BigDecimal(String.valueOf(str)), io.mpos.transactions.Currency.EUR)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MposUi.REQUEST_CODE_PAYMENT) {
            if (resultCode == MposUi.RESULT_CODE_APPROVED) {
                // Transaction or Refund was approved
